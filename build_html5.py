...
def build():
    ...
    <div class="{PANEL} border-[#F2B03C]/40">
      ...
      <ul class="text-[13px] text-[#C9D6DA] list-disc pl-5 leading-relaxed">
        ...
        <li class="mb-1.5">The midcap ETF's Yahoo history starts {esc(R['start_date'])}, so this backtest — like the last report — entirely misses the 2008 and 2011 crashes; it spans one pandemic crash, one rate-hike correction, and a couple of smaller wobbles.</li>
